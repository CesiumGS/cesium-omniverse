...
call "%KIT_DIR%\kit.exe"  --enable omni.kit.test --/app/enableStdoutOutput=0 --/exts/omni.kit.test/testExts/0='cesium.omniverse' --ext-folder "%KIT_DIR%/extscore" --ext-folder "%KIT_DIR%/exts" --ext-folder "%KIT_DIR%/apps" --ext-folder "%~dp0/../exts" --/exts/omni.kit.test/testExtApp="%~dp0/../apps/cesium.omniverse.app.kit" --/exts/omni.kit.test/testExtOutputPath="%~dp0/../_testoutput" --portable-root "%KIT_DIR%/" --/telemetry/mode=test %*
