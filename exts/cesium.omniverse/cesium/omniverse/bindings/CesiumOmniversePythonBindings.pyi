...
class FabricStatistics:
    def __init__(self, *args, **kwargs) -> None: ...
    @property
    def number_of_geometries_loaded(self) -> int: ...
    @property
    def number_of_geometries_visible(self) -> int: ...
    @property
    def number_of_materials_loaded(self) -> int: ...
...
class ICesiumOmniverseInterface:
    ...
    def get_fabric_statistics(self, *args, **kwargs) -> Any: ...
