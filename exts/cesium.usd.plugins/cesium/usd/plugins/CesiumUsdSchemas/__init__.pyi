...
class Tokens(Boost.Python.instance):
    ...
    def __reduce__(cls) -> Any: ...
    @property
    def CesiumDataPrim(self) -> Any: ...
    @property
    def CesiumEllipsoidPrim(self) -> Any: ...
    @property
    def CesiumGeoreferencePrim(self) -> Any: ...
    @property
    def CesiumGlobeAnchorSchemaAPI(self) -> Any: ...
    @property
    def CesiumIonRasterOverlayPrim(self) -> Any: ...
    @property
    def CesiumIonServerPrim(self) -> Any: ...
    @property
    def CesiumPolygonRasterOverlayPrim(self) -> Any: ...
    @property
    def CesiumRasterOverlayPrim(self) -> Any: ...
    @property
    def CesiumTileMapServiceRasterOverlayPrim(self) -> Any: ...
    @property
    def CesiumTilesetPrim(self) -> Any: ...
    @property
    def CesiumWebMapServiceRasterOverlayPrim(self) -> Any: ...
    @property
    def CesiumWebMapTileServiceRasterOverlayPrim(self) -> Any: ...
    @property
