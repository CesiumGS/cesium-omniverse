...
PYBIND11_MODULE(CesiumOmniversePythonBindings, m) {
    ...
    carb::defineInterfaceClass<ICesiumOmniverseInterface>(
        ...
        .def("create_test_point_cloud", &ICesiumOmniverseInterface::createTestPointCloud)
        .def("run_kernel_on_point_cloud", &ICesiumOmniverseInterface::runKernelOnPointCloud);
    // clang-format on
