...
namespace cesium::omniverse::detail {
...
#define CALL_TEMPLATED_FUNCTION_WITH_RUNTIME_DATA_TYPE(FUNCTION_NAME, TYPE, ...) \
    CppUtil::dispatch<detail::DataTypeCount>([](auto i) { return FUNCTION_NAME<i.value>; }, TYPE, __VA_ARGS__)

// In C++ 20 we don't need this second define
#define CALL_TEMPLATED_FUNCTION_WITH_RUNTIME_DATA_TYPE_NO_ARGS(FUNCTION_NAME, TYPE) \
    CppUtil::dispatch<detail::DataTypeCount>(                                       \
        [](auto i) { return FUNCTION_NAME<i.value>; }, TYPE) // NOLINT(bugprone-macro-parentheses)

#define CALL_TEMPLATED_FUNCTION_WITH_RUNTIME_MDL_TYPE(FUNCTION_NAME, TYPE, ...) \
    CppUtil::dispatch<detail::MdlInternalPropertyTypeCount>(                    \
        [](auto i) { return FUNCTION_NAME<i.value>; }, TYPE, __VA_ARGS__)

#define CALL_TEMPLATED_FUNCTION_WITH_RUNTIME_MDL_TYPE_NO_ARGS(FUNCTION_NAME, TYPE) \
    CppUtil::dispatch<detail::MdlInternalPropertyTypeCount>(                       \
        [](auto i) { return FUNCTION_NAME<i.value>; }, TYPE) // NOLINT(bugprone-macro-parentheses)

namespace cesium::omniverse::DataTypeUtil {

template <DataType T> using GetNativeType = typename detail::GetNativeTypeImpl<T>::Type;

template <MdlInternalPropertyType T>
using GetMdlInternalPropertyRawType = typename detail::GetMdlInternalPropertyRawTypeImpl<T>::Type;

template <MdlInternalPropertyType T>
using GetMdlInternalPropertyTransformedType = typename detail::GetMdlInternalPropertyTransformedTypeImplImpl<T>::Type;

template <typename RawType, typename TransformedType> constexpr DataType getTypeReverse() {
    return detail::GetTypeReverseImpl<RawType, TransformedType>::Type;
};

template <DataType T> constexpr DataType getComponentType() {
    return detail::GetComponentTypeImpl<T>::Type;
};
...
template <DataType T> constexpr DataType getUnnormalizedType() {
    return detail::GetUnnormalizedTypeImpl<T>::Type;
};
...
template <DataType T> constexpr DataType getTransformedType() {
    return detail::GetTransformedTypeImpl<T>::Type;
};
...
template <DataType T> constexpr DataType getPrimvarType() {
    return detail::GetPrimvarTypeImpl<T>::Type;
};
...
template <DataType T> constexpr omni::fabric::BaseDataType getPrimvarBaseDataType() {
    return detail::GetPrimvarBaseDataTypeImpl<T>::BaseDataType;
};
...
template <DataType T> constexpr carb::Format getTextureFormat() {
    return detail::GetTextureFormatImpl<T>::TextureFormat;
};
...
template <DataType T> constexpr DataType getPropertyTableTextureType() {
    return detail::GetPropertyTableTextureTypeImpl<T>::Type;
};
...
template <DataType T> constexpr MdlInternalPropertyType getMdlInternalPropertyType() {
    return detail::GetMdlInternalPropertyTypeImpl<T>::Type;
};
