...
template <DataType T> struct GetNormalizedTypeImpl;
template <> struct GetNormalizedTypeImpl<DataType::UINT8> { using Type = uint8_t; };
template <> struct GetNormalizedTypeImpl<DataType::INT8> { using Type = int8_t; };
template <> struct GetNormalizedTypeImpl<DataType::UINT16> { using Type = uint16_t; };
template <> struct GetNormalizedTypeImpl<DataType::INT16> { using Type = int16_t; };
template <> struct GetNormalizedTypeImpl<DataType::UINT32> { using Type = uint32_t; };
template <> struct GetNormalizedTypeImpl<DataType::INT32> { using Type = int32_t; };
template <> struct GetNormalizedTypeImpl<DataType::UINT64> { using Type = uint64_t; };
template <> struct GetNormalizedTypeImpl<DataType::INT64> { using Type = int64_t; };
template <> struct GetNormalizedTypeImpl<DataType::FLOAT32> { using Type = float; };
template <> struct GetNormalizedTypeImpl<DataType::FLOAT64> { using Type = double; };
template <> struct GetNormalizedTypeImpl<DataType::UINT8_NORM> { using Type = double; };
template <> struct GetNormalizedTypeImpl<DataType::INT8_NORM> { using Type = double; };
template <> struct GetNormalizedTypeImpl<DataType::UINT16_NORM> { using Type = double; };
template <> struct GetNormalizedTypeImpl<DataType::INT16_NORM> { using Type = double; };
template <> struct GetNormalizedTypeImpl<DataType::UINT32_NORM> { using Type = double; };
template <> struct GetNormalizedTypeImpl<DataType::INT32_NORM> { using Type = double; };
template <> struct GetNormalizedTypeImpl<DataType::UINT64_NORM> { using Type = double; };
template <> struct GetNormalizedTypeImpl<DataType::INT64_NORM> { using Type = double; };
template <> struct GetNormalizedTypeImpl<DataType::VEC2_UINT8> { using Type = glm::u8vec2; };
template <> struct GetNormalizedTypeImpl<DataType::VEC2_INT8> { using Type = glm::i8vec2; };
template <> struct GetNormalizedTypeImpl<DataType::VEC2_UINT16> { using Type = glm::u16vec2; };
template <> struct GetNormalizedTypeImpl<DataType::VEC2_INT16> { using Type = glm::i16vec2; };
template <> struct GetNormalizedTypeImpl<DataType::VEC2_UINT32> { using Type = glm::u32vec2; };
template <> struct GetNormalizedTypeImpl<DataType::VEC2_INT32> { using Type = glm::i32vec2; };
template <> struct GetNormalizedTypeImpl<DataType::VEC2_UINT64> { using Type = glm::u64vec2; };
template <> struct GetNormalizedTypeImpl<DataType::VEC2_INT64> { using Type = glm::i64vec2; };
template <> struct GetNormalizedTypeImpl<DataType::VEC2_FLOAT32> { using Type = glm::f32vec2; };
template <> struct GetNormalizedTypeImpl<DataType::VEC2_FLOAT64> { using Type = glm::f64vec2; };
template <> struct GetNormalizedTypeImpl<DataType::VEC2_UINT8_NORM> { using Type = glm::f64vec2; };
template <> struct GetNormalizedTypeImpl<DataType::VEC2_INT8_NORM> { using Type = glm::f64vec2; };
template <> struct GetNormalizedTypeImpl<DataType::VEC2_UINT16_NORM> { using Type = glm::f64vec2; };
template <> struct GetNormalizedTypeImpl<DataType::VEC2_INT16_NORM> { using Type = glm::f64vec2; };
template <> struct GetNormalizedTypeImpl<DataType::VEC2_UINT32_NORM> { using Type = glm::f64vec2; };
template <> struct GetNormalizedTypeImpl<DataType::VEC2_INT32_NORM> { using Type = glm::f64vec2; };
template <> struct GetNormalizedTypeImpl<DataType::VEC2_UINT64_NORM> { using Type = glm::f64vec2; };
template <> struct GetNormalizedTypeImpl<DataType::VEC2_INT64_NORM> { using Type = glm::f64vec2; };
template <> struct GetNormalizedTypeImpl<DataType::VEC3_UINT8> { using Type = glm::u8vec3; };
template <> struct GetNormalizedTypeImpl<DataType::VEC3_INT8> { using Type = glm::i8vec3; };
template <> struct GetNormalizedTypeImpl<DataType::VEC3_UINT16> { using Type = glm::u16vec3; };
template <> struct GetNormalizedTypeImpl<DataType::VEC3_INT16> { using Type = glm::i16vec3; };
template <> struct GetNormalizedTypeImpl<DataType::VEC3_UINT32> { using Type = glm::u32vec3; };
template <> struct GetNormalizedTypeImpl<DataType::VEC3_INT32> { using Type = glm::i32vec3; };
template <> struct GetNormalizedTypeImpl<DataType::VEC3_UINT64> { using Type = glm::u64vec3; };
template <> struct GetNormalizedTypeImpl<DataType::VEC3_INT64> { using Type = glm::i64vec3; };
template <> struct GetNormalizedTypeImpl<DataType::VEC3_FLOAT32> { using Type = glm::f32vec3; };
template <> struct GetNormalizedTypeImpl<DataType::VEC3_FLOAT64> { using Type = glm::f64vec3; };
template <> struct GetNormalizedTypeImpl<DataType::VEC3_UINT8_NORM> { using Type = glm::f64vec3; };
template <> struct GetNormalizedTypeImpl<DataType::VEC3_INT8_NORM> { using Type = glm::f64vec3; };
template <> struct GetNormalizedTypeImpl<DataType::VEC3_UINT16_NORM> { using Type = glm::f64vec3; };
template <> struct GetNormalizedTypeImpl<DataType::VEC3_INT16_NORM> { using Type = glm::f64vec3; };
template <> struct GetNormalizedTypeImpl<DataType::VEC3_UINT32_NORM> { using Type = glm::f64vec3; };
template <> struct GetNormalizedTypeImpl<DataType::VEC3_INT32_NORM> { using Type = glm::f64vec3; };
template <> struct GetNormalizedTypeImpl<DataType::VEC3_UINT64_NORM> { using Type = glm::f64vec3; };
template <> struct GetNormalizedTypeImpl<DataType::VEC3_INT64_NORM> { using Type = glm::f64vec3; };
template <> struct GetNormalizedTypeImpl<DataType::VEC4_UINT8> { using Type = glm::u8vec4; };
template <> struct GetNormalizedTypeImpl<DataType::VEC4_INT8> { using Type = glm::i8vec4; };
template <> struct GetNormalizedTypeImpl<DataType::VEC4_UINT16> { using Type = glm::u16vec4; };
template <> struct GetNormalizedTypeImpl<DataType::VEC4_INT16> { using Type = glm::i16vec4; };
template <> struct GetNormalizedTypeImpl<DataType::VEC4_UINT32> { using Type = glm::u32vec4; };
template <> struct GetNormalizedTypeImpl<DataType::VEC4_INT32> { using Type = glm::i32vec4; };
template <> struct GetNormalizedTypeImpl<DataType::VEC4_UINT64> { using Type = glm::u64vec4; };
template <> struct GetNormalizedTypeImpl<DataType::VEC4_INT64> { using Type = glm::i64vec4; };
template <> struct GetNormalizedTypeImpl<DataType::VEC4_FLOAT32> { using Type = glm::f32vec4; };
template <> struct GetNormalizedTypeImpl<DataType::VEC4_FLOAT64> { using Type = glm::f64vec4; };
template <> struct GetNormalizedTypeImpl<DataType::VEC4_UINT8_NORM> { using Type = glm::f64vec4; };
template <> struct GetNormalizedTypeImpl<DataType::VEC4_INT8_NORM> { using Type = glm::f64vec4; };
template <> struct GetNormalizedTypeImpl<DataType::VEC4_UINT16_NORM> { using Type = glm::f64vec4; };
template <> struct GetNormalizedTypeImpl<DataType::VEC4_INT16_NORM> { using Type = glm::f64vec4; };
template <> struct GetNormalizedTypeImpl<DataType::VEC4_UINT32_NORM> { using Type = glm::f64vec4; };
template <> struct GetNormalizedTypeImpl<DataType::VEC4_INT32_NORM> { using Type = glm::f64vec4; };
template <> struct GetNormalizedTypeImpl<DataType::VEC4_UINT64_NORM> { using Type = glm::f64vec4; };
template <> struct GetNormalizedTypeImpl<DataType::VEC4_INT64_NORM> { using Type = glm::f64vec4; };
template <> struct GetNormalizedTypeImpl<DataType::MAT2_UINT8> { using Type = glm::mat<2, 2, uint8_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT2_INT8> { using Type = glm::mat<2, 2, int8_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT2_UINT16> { using Type = glm::mat<2, 2, uint16_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT2_INT16> { using Type = glm::mat<2, 2, int16_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT2_UINT32> { using Type = glm::mat<2, 2, uint32_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT2_INT32> { using Type = glm::mat<2, 2, int32_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT2_UINT64> { using Type = glm::mat<2, 2, uint64_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT2_INT64> { using Type = glm::mat<2, 2, int64_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT2_FLOAT32> { using Type = glm::f32mat2; };
template <> struct GetNormalizedTypeImpl<DataType::MAT2_FLOAT64> { using Type = glm::f64mat2; };
template <> struct GetNormalizedTypeImpl<DataType::MAT2_UINT8_NORM> { using Type = glm::f64mat2; };
template <> struct GetNormalizedTypeImpl<DataType::MAT2_INT8_NORM> { using Type = glm::f64mat2; };
template <> struct GetNormalizedTypeImpl<DataType::MAT2_UINT16_NORM> { using Type = glm::f64mat2; };
template <> struct GetNormalizedTypeImpl<DataType::MAT2_INT16_NORM> { using Type = glm::f64mat2; };
template <> struct GetNormalizedTypeImpl<DataType::MAT2_UINT32_NORM> { using Type = glm::f64mat2; };
template <> struct GetNormalizedTypeImpl<DataType::MAT2_INT32_NORM> { using Type = glm::f64mat2; };
template <> struct GetNormalizedTypeImpl<DataType::MAT2_UINT64_NORM> { using Type = glm::f64mat2; };
template <> struct GetNormalizedTypeImpl<DataType::MAT2_INT64_NORM> { using Type = glm::f64mat2; };
template <> struct GetNormalizedTypeImpl<DataType::MAT3_UINT8> { using Type = glm::mat<3, 3, uint8_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT3_INT8> { using Type = glm::mat<3, 3, int8_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT3_UINT16> { using Type = glm::mat<3, 3, uint16_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT3_INT16> { using Type = glm::mat<3, 3, int16_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT3_UINT32> { using Type = glm::mat<3, 3, uint32_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT3_INT32> { using Type = glm::mat<3, 3, int32_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT3_UINT64> { using Type = glm::mat<3, 3, uint64_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT3_INT64> { using Type = glm::mat<3, 3, int64_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT3_FLOAT32> { using Type = glm::f32mat3; };
template <> struct GetNormalizedTypeImpl<DataType::MAT3_FLOAT64> { using Type = glm::f64mat3; };
template <> struct GetNormalizedTypeImpl<DataType::MAT3_UINT8_NORM> { using Type = glm::f64mat3; };
template <> struct GetNormalizedTypeImpl<DataType::MAT3_INT8_NORM> { using Type = glm::f64mat3; };
template <> struct GetNormalizedTypeImpl<DataType::MAT3_UINT16_NORM> { using Type = glm::f64mat3; };
template <> struct GetNormalizedTypeImpl<DataType::MAT3_INT16_NORM> { using Type = glm::f64mat3; };
template <> struct GetNormalizedTypeImpl<DataType::MAT3_UINT32_NORM> { using Type = glm::f64mat3; };
template <> struct GetNormalizedTypeImpl<DataType::MAT3_INT32_NORM> { using Type = glm::f64mat3; };
template <> struct GetNormalizedTypeImpl<DataType::MAT3_UINT64_NORM> { using Type = glm::f64mat3; };
template <> struct GetNormalizedTypeImpl<DataType::MAT3_INT64_NORM> { using Type = glm::f64mat3; };
template <> struct GetNormalizedTypeImpl<DataType::MAT4_UINT8> { using Type = glm::mat<4, 4, uint8_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT4_INT8> { using Type = glm::mat<4, 4, int8_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT4_UINT16> { using Type = glm::mat<4, 4, uint16_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT4_INT16> { using Type = glm::mat<4, 4, int16_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT4_UINT32> { using Type = glm::mat<4, 4, uint32_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT4_INT32> { using Type = glm::mat<4, 4, int32_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT4_UINT64> { using Type = glm::mat<4, 4, uint64_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT4_INT64> { using Type = glm::mat<4, 4, int64_t>; };
template <> struct GetNormalizedTypeImpl<DataType::MAT4_FLOAT32> { using Type = glm::f32mat4; };
template <> struct GetNormalizedTypeImpl<DataType::MAT4_FLOAT64> { using Type = glm::f64mat4; };
template <> struct GetNormalizedTypeImpl<DataType::MAT4_UINT8_NORM> { using Type = glm::f64mat4; };
template <> struct GetNormalizedTypeImpl<DataType::MAT4_INT8_NORM> { using Type = glm::f64mat4; };
template <> struct GetNormalizedTypeImpl<DataType::MAT4_UINT16_NORM> { using Type = glm::f64mat4; };
template <> struct GetNormalizedTypeImpl<DataType::MAT4_INT16_NORM> { using Type = glm::f64mat4; };
template <> struct GetNormalizedTypeImpl<DataType::MAT4_UINT32_NORM> { using Type = glm::f64mat4; };
template <> struct GetNormalizedTypeImpl<DataType::MAT4_INT32_NORM> { using Type = glm::f64mat4; };
template <> struct GetNormalizedTypeImpl<DataType::MAT4_UINT64_NORM> { using Type = glm::f64mat4; };
template <> struct GetNormalizedTypeImpl<DataType::MAT4_INT64_NORM> { using Type = glm::f64mat4; };

template <DataType T> using GetNormalizedType = typename GetNormalizedTypeImpl<T>::Type;
