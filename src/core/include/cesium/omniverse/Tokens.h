...
extern const omni::fabric::TokenC MaterialNetwork;
...
extern const omni::fabric::TokenC _parameters;
extern const omni::fabric::TokenC _relationships_inputId;
extern const omni::fabric::TokenC _relationships_inputName;
extern const omni::fabric::TokenC _relationships_outputId;
extern const omni::fabric::TokenC _relationships_outputName;
extern const omni::fabric::TokenC _terminals;
...
const omni::fabric::Type _parameters(omni::fabric::BaseDataType::eToken, 1, 1, omni::fabric::AttributeRole::eNone);
...
const omni::fabric::Type _relationships_outputId(omni::fabric::BaseDataType::eUInt64, 1, 1, omni::fabric::AttributeRole::eNone);
const omni::fabric::Type _relationships_outputName(omni::fabric::BaseDataType::eToken, 1, 1, omni::fabric::AttributeRole::eNone);
const omni::fabric::Type _terminals(omni::fabric::BaseDataType::eUInt64, 1, 1, omni::fabric::AttributeRole::eNone);
