...
UsdMaterial::UsdMaterial(pxr::SdfPath path, const OmniMaterialDefinition& materialDefinition)
...
void UsdMaterial::initialize(pxr::SdfPath path, const OmniMaterialDefinition& materialDefinition) {
...
void UsdMaterial::setInitialValues(const OmniMaterialDefinition& materialDefinition) {
    const auto hasBaseColorTexture = _materialDefinition.hasBaseColorTexture();
