...
public:
  ...
  ///
  CESIUM_API
  static CesiumGeoreference Get(const UsdStagePtr &stage, const SdfPath &path);
...
public:
  ...
  // LATITUDE
  // --------------------------------------------------------------------- //
  /// A double representing the latitude in decimal degrees. Has a fallback
  /// value of 0.0.
  ///
  /// | ||
  /// | -- | -- |
...
public:
  ...
  // LONGITUDE
  // --------------------------------------------------------------------- //
  /// A double representing the longitude in decimal degrees. Has a fallback
  /// value of 0.0.
  ///
  /// | ||
  /// | -- | -- |
