...
/// \class CesiumImagery
///
/// Adds a prim for representing an imagery layer. Should be a child of a
/// tileset.
///
...
public:
  ...
  /// an invalid \p prim
  explicit CesiumImagery(const UsdPrim &prim = UsdPrim()) : UsdTyped(prim) {}
  ...
  /// \endcode
  ///
  static CesiumImagery Get(const UsdStagePtr &stage, const SdfPath &path);
  ...
  ///
  static CesiumImagery Define(const UsdStagePtr &stage, const SdfPath &path);
