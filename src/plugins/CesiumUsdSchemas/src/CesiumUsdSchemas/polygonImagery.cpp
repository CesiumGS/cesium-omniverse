...
UsdRelationship
CesiumPolygonImagery::GetBasisCurvesBindingRel() const
{
    return GetPrim().GetRelationship(CesiumTokens->cesiumBasicCurvesBinding);
}

UsdRelationship
CesiumPolygonImagery::CreateBasisCurvesBindingRel() const
{
    return GetPrim().CreateRelationship(CesiumTokens->cesiumBasicCurvesBinding,
                       /* custom = */ false);
}
