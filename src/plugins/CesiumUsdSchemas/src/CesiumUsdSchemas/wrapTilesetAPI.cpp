...
struct CesiumTilesetAPI_CanApplyResult : 
    public TfPyAnnotatedBoolResult<std::string>
{
    CesiumTilesetAPI_CanApplyResult(bool val, std::string const &msg) :
        TfPyAnnotatedBoolResult<std::string>(val, msg) {}
};

static CesiumTilesetAPI_CanApplyResult
_WrapCanApply(const UsdPrim& prim)
{
    std::string whyNot;
    bool result = CesiumTilesetAPI::CanApply(prim, &whyNot);
    return CesiumTilesetAPI_CanApplyResult(result, whyNot);
}
...
void wrapCesiumTilesetAPI()
{
    ...
    CesiumTilesetAPI_CanApplyResult::Wrap<CesiumTilesetAPI_CanApplyResult>(
